...
Provide `outcomes.txt` file if trying to transfer learn on specific task or dataset. Include two columns, `sample` and `outcomes` [OPTIONAL]. `outcomes` column should contain binary outcome label (either 0 or 1). 
